...
def test():
    ...
    test_query_loader = torch.utils.data.DataLoader(test_dataset, batch_size=8, shuffle=False, 
    ...
    test_database_loader = torch.utils.data.DataLoader(database_dataset, batch_size=8, shuffle=False, 
                                                       pin_memory=True, drop_last = False, num_workers = 4)
    with torch.no_grad():
